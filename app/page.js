    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">Schedulrr helps you manage time efficiently. Create events, set availability, and let others seamlessly book time with you.
          </p>
          <Link href="/dashboard">
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        <h2 className="test-3xl font-bold mb-4">Ready to Simplify Your Scheduling?</h2>
        <p className="text-xl mb-6">
          Join thousands of professional who trust Schedulrr for efficient time management.
        </p>
        <Link href="/dashboard">
